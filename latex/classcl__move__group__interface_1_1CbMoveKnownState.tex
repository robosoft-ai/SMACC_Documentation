...
\DoxyCodeLine{00065     YAML::Parser \mbox{\hyperlink{namespacegenerate__debs_a4a9ae4bb85fc62d7973ea3d09ced6c26}{parser}}(ifs);}
\DoxyCodeLine{00066     \mbox{\hyperlink{namespacegenerate__debs_a4a9ae4bb85fc62d7973ea3d09ced6c26}{parser}}.GetNextDocument(node);}
...
\DoxyCodeLine{00081         \{}
\DoxyCodeLine{00082           std::string \mbox{\hyperlink{namespacekeyboard__server__node_af0ebd8a9e1564ddc13a227c727602466}{key}} = it-\/>first.as<std::string>();}
\DoxyCodeLine{00083           \textcolor{keywordtype}{double} value = it-\/>second.as<\textcolor{keywordtype}{double}>();}
\DoxyCodeLine{00084           ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{"{} joint -\/ "{}} << \mbox{\hyperlink{namespacekeyboard__server__node_af0ebd8a9e1564ddc13a227c727602466}{key}} << \textcolor{stringliteral}{"{}: "{}} << value);}
\DoxyCodeLine{00085           jointStates[\mbox{\hyperlink{namespacekeyboard__server__node_af0ebd8a9e1564ddc13a227c727602466}{key}}] = value;}
\DoxyCodeLine{00086         \}}
\DoxyCodeLine{00087 }
...
References \mbox{\hyperlink{keyboard__server__node_8py_source_l00028}{keyboard\+\_\+server\+\_\+node\+::key}}, and \mbox{\hyperlink{generate__debs_8py_source_l00281}{generate\+\_\+debs\+::parser}}.
