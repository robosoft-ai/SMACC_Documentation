...
\DoxyCodeLine{\Hypertarget{waypoints__navigator_8cpp_source_l00144}00144       \textcolor{keywordflow}{for} (uint64\_t i = 0; i < wp\_node-\/>size(); ++i)}
...
\DoxyCodeLine{\Hypertarget{waypoints__navigator_8cpp_source_l00165}00165           ROS\_ERROR(\textcolor{stringliteral}{"{}parsing waypoint file, syntax error in point \%ld"{}}, i);}
