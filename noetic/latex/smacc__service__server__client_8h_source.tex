...
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00026}00026   \mbox{\hyperlink{classsmacc_1_1SmaccSignal}{smacc::SmaccSignal}}<void(\mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a9778b3fc53f067a890e2731a52cd9f12}{TServiceRequest}}\&, std::shared\_ptr<TServiceResponse>)>}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00027}\mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a4c29a1dd597d094e88ab0c2c5d5b577c}{00027}}       \mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a4c29a1dd597d094e88ab0c2c5d5b577c}{onServiceRequestReceived\_}};}
...
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00030}\mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_ad57eabc5e0cbef07773e52fff5d1b404}{00030}}   boost::signals2::connection \mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_ad57eabc5e0cbef07773e52fff5d1b404}{onServiceRequestReceived}}(}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00031}00031       \textcolor{keywordtype}{void} (T::*callback)(\mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a9778b3fc53f067a890e2731a52cd9f12}{TServiceRequest}}\&, std::shared\_ptr<TServiceResponse>),}
...
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00034}00034         \mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a4c29a1dd597d094e88ab0c2c5d5b577c}{onServiceRequestReceived\_}}, callback, \textcolor{keywordtype}{object});}
...
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00058}00058   \{}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00059}00059     std::shared\_ptr<TServiceResponse> response\{\textcolor{keyword}{new} \mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a61f1cab2c65d38d5417183887f186dce}{TServiceResponse}}\};}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00060}00060     \mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a4c29a1dd597d094e88ab0c2c5d5b577c}{onServiceRequestReceived\_}}(req, response);}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00061}00061 <<<<<<< HEAD}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00062}00062     \textcolor{comment}{// if (!ret\_val)  // Check if response is empty}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00063}00063     \textcolor{comment}{// \{}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00064}00064     \textcolor{comment}{//   ROS\_WARN(}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00065}00065     \textcolor{comment}{//       "{}No return value received from service call. Are you returning a "{}}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00066}00066     \textcolor{comment}{//       "{}value?"{});}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00067}00067     \textcolor{comment}{//   return false;}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00068}00068     \textcolor{comment}{// \}}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00069}00069     res = *response;}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00070}00070     \textcolor{comment}{// return *ret\_val;}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00071}00071 =======}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00072}00072 }
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00073}00073     res = *response;}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00074}00074     \textcolor{keywordflow}{return} \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00075}00075 >>>>>>> 177bd9fb998f57de5b554a025e0a3e1c90deddfe}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00076}00076   \}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00077}\mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a7094af7e5fcc1d0cf02a8890d2f066b1}{00077}}   ros::ServiceServer \mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_a7094af7e5fcc1d0cf02a8890d2f066b1}{server\_}};}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00078}\mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_aa0dc1ec67303da8b918861d10992cea0}{00078}}   \textcolor{keywordtype}{bool} \mbox{\hyperlink{classsmacc_1_1client__bases_1_1SmaccServiceServerClient_aa0dc1ec67303da8b918861d10992cea0}{initialized\_}};}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00079}00079 \};}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00080}00080 \}  \textcolor{comment}{// namespace client\_bases}}
\DoxyCodeLine{\Hypertarget{smacc__service__server__client_8h_source_l00081}00081 \}  \textcolor{comment}{// namespace smacc}}
