...
\begin{DoxyCode}{0}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00001}00001 \textcolor{preprocessor}{\#include <move\_base\_z\_client\_plugin/client\_behaviors/cb\_undo\_path\_backwards2.h>}}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00002}00002 \textcolor{preprocessor}{\#include <move\_base\_z\_client\_plugin/components/odom\_tracker/odom\_tracker.h>}}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00003}00003 \textcolor{preprocessor}{\#include <move\_base\_z\_client\_plugin/components/planner\_switcher/planner\_switcher.h>}}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00015}00015 CbUndoPathBackwards2::CbUndoPathBackwards2() : goalLinePassed\_(false)}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00016}00016 \{}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00017}00017   triggerThreshold\_ = 0.01;  \textcolor{comment}{// 10 mm}}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00020}00020 \textcolor{keywordtype}{void} CbUndoPathBackwards2::onEntry()}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00021}00021 \{}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00022}00022   odomTracker\_ = moveBaseClient\_-\/>getComponent<OdomTracker>();}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00023}00023 }
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00024}00024   \textcolor{keyword}{auto} plannerSwitcher = moveBaseClient\_-\/>getComponent<PlannerSwitcher>();}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00025}00025   robotPose\_ = moveBaseClient\_-\/>getComponent<cl\_move\_base\_z::Pose>();}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00026}00026 }
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00027}00027   nav\_msgs::Path forwardpath = odomTracker\_-\/>getPath();}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00030}00030   odomTracker\_-\/>setWorkingMode(WorkingMode::CLEAR\_PATH);}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00036}00036     goal\_.target\_pose = forwardpath.poses.front();}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00037}00037     initial\_plane\_side\_ = evalPlaneSide(robotPose\_-\/>toPoseMsg());}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00039}00039     moveBaseClient\_-\/>sendGoal(goal\_);}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00048}00048 \textcolor{keywordtype}{float} CbUndoPathBackwards2::evalPlaneSide(\textcolor{keyword}{const} geometry\_msgs::Pose\& pose)}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00056}00056   \textcolor{keyword}{auto} alpha = tf::getYaw(goal\_.target\_pose.pose.orientation);}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00057}00057   \textcolor{keyword}{auto} y0 = goal\_.target\_pose.pose.position.y;}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00058}00058   \textcolor{keyword}{auto} x0 = goal\_.target\_pose.pose.position.x;}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00064}00064 \textcolor{keywordtype}{void} CbUndoPathBackwards2::update()}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00065}00065 \{}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00066}00066   \textcolor{keyword}{auto} pose = robotPose\_-\/>toPoseMsg();}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00067}00067 }
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00068}00068   \textcolor{keywordtype}{float} evalimplicit = evalPlaneSide(pose);}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00069}00069   \textcolor{keywordflow}{if} (\mbox{\hyperlink{namespacecl__move__base__z_ae144a2fabd00ba70fdc8099878cb3dac}{sgn}}(evalimplicit) != \mbox{\hyperlink{namespacecl__move__base__z_ae144a2fabd00ba70fdc8099878cb3dac}{sgn}}(initial\_plane\_side\_))}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00072}00072                                       << evalimplicit << \textcolor{stringliteral}{"{}/"{}} << this-\/>initial\_plane\_side\_);}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00073}00073 }
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00074}00074     \textcolor{keywordflow}{if} (fabs(evalimplicit) > triggerThreshold\_ \textcolor{comment}{/*meters*/})}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00077}00077                                       << evalimplicit << \textcolor{stringliteral}{"{}/"{}} << this-\/>initial\_plane\_side\_);}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00078}00078       moveBaseClient\_-\/>cancelGoal();}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00079}00079       \textcolor{comment}{// this-\/>postSuccessEvent();}}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00080}00080       this-\/>postVirtualLinePassed\_();}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00086}00086                                                                                        << this-\/>initial\_plane\_side\_);}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00090}00090 \textcolor{keywordtype}{void} CbUndoPathBackwards2::publishMarkers()}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00091}00091 \{}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00092}00092   \textcolor{keywordtype}{double} phi = tf::getYaw(goal\_.target\_pose.pose.orientation);}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00093}00093   visualization\_msgs::Marker marker;}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00094}00094   marker.header.frame\_id = robotPose\_-\/>getReferenceFrame();}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00109}00109   marker.pose = goal\_.target\_pose.pose;}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00124}00124   this-\/>visualizationMarkersPub\_.publish(ma);}
...
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00127}00127 \textcolor{keywordtype}{void} CbUndoPathBackwards2::onExit()}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00128}00128 \{}
\DoxyCodeLine{\Hypertarget{cb__undo__path__backwards2_8cpp_source_l00129}00129   \textcolor{keyword}{auto}* odomTracker = moveBaseClient\_-\/>getComponent<OdomTracker>();}
