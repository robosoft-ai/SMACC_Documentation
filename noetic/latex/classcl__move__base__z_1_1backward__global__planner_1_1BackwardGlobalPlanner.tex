...
Referenced by \mbox{\hyperlink{backward__global__planner_8cpp_source_l00147}{make\+Plan()}}.
...
Definition at line \mbox{\hyperlink{backward__global__planner_8cpp_source_l00147}{147}} of file \mbox{\hyperlink{backward__global__planner_8cpp_source}{backward\+\_\+global\+\_\+planner.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00149 \{}
\DoxyCodeLine{00150     \textcolor{comment}{//ROS\_WARN\_NAMED("{}Backwards"{}, "{}Backwards global planner: Generating global plan "{});}}
\DoxyCodeLine{00151     \textcolor{comment}{//ROS\_WARN\_NAMED("{}Backwards"{}, "{}Clearing..."{});}}
\DoxyCodeLine{00152 }
\DoxyCodeLine{00153     plan.clear();}
\DoxyCodeLine{00154 }
\DoxyCodeLine{00155     this-\/>\mbox{\hyperlink{classcl__move__base__z_1_1backward__global__planner_1_1BackwardGlobalPlanner_a1b4d2eb717f9f63f2309def37c6ce297}{createDefaultBackwardPath}}(start, goal, plan);}
\DoxyCodeLine{00156     \textcolor{comment}{//this-\/>createPureSpiningAndStragihtLineBackwardPath(start, goal, plan);}}
\DoxyCodeLine{00157 }
\DoxyCodeLine{00158     \textcolor{comment}{//ROS\_INFO\_STREAM("{} start -\/ "{} << start);}}
\DoxyCodeLine{00159     \textcolor{comment}{//ROS\_INFO\_STREAM("{} end -\/ "{} << goal.pose.position);}}
\DoxyCodeLine{00160 }
\DoxyCodeLine{00161     \textcolor{comment}{//ROS\_INFO("{}3 -\/ heading to goal orientation"{});}}
\DoxyCodeLine{00162     \textcolor{comment}{//double goalOrientation = angles::normalize\_angle(tf::getYaw(goal.pose.orientation));}}
\DoxyCodeLine{00163     \textcolor{comment}{//cl\_move\_base\_z::makePureSpinningSubPlan(prevState,goalOrientation,plan);}}
\DoxyCodeLine{00164 }
\DoxyCodeLine{00165     \textcolor{comment}{//ROS\_WARN\_STREAM( "{}MAKE PLAN INVOKED, plan size:"{}<< plan.size());}}
\DoxyCodeLine{00166     \mbox{\hyperlink{classcl__move__base__z_1_1backward__global__planner_1_1BackwardGlobalPlanner_a3c6784cad10fdadf28323380fe3d6d2b}{publishGoalMarker}}(goal.pose, 1.0, 0, 1.0);}
\DoxyCodeLine{00167 }
\DoxyCodeLine{00168     nav\_msgs::Path planMsg;}
\DoxyCodeLine{00169     planMsg.poses = plan;}
\DoxyCodeLine{00170     planMsg.header.frame\_id = this-\/>\mbox{\hyperlink{classcl__move__base__z_1_1backward__global__planner_1_1BackwardGlobalPlanner_a7103c15e6540a514acd421c3c6e194a4}{costmap\_ros\_}}-\/>getGlobalFrameID();}
\DoxyCodeLine{00171 }
\DoxyCodeLine{00172         \textcolor{comment}{// check plan rejection}}
\DoxyCodeLine{00173     \textcolor{keywordtype}{bool} acceptedGlobalPlan = \textcolor{keyword}{true};}
\DoxyCodeLine{00174 }
\DoxyCodeLine{00175     \textcolor{comment}{// static const unsigned char NO\_INFORMATION = 255;}}
\DoxyCodeLine{00176     \textcolor{comment}{// static const unsigned char LETHAL\_OBSTACLE = 254;}}
\DoxyCodeLine{00177     \textcolor{comment}{// static const unsigned char INSCRIBED\_INFLATED\_OBSTACLE = 253;}}
\DoxyCodeLine{00178     \textcolor{comment}{// static const unsigned char FREE\_SPACE = 0;}}
\DoxyCodeLine{00179 }
\DoxyCodeLine{00180     costmap\_2d::Costmap2D *costmap2d = this-\/>\mbox{\hyperlink{classcl__move__base__z_1_1backward__global__planner_1_1BackwardGlobalPlanner_a7103c15e6540a514acd421c3c6e194a4}{costmap\_ros\_}}-\/>getCostmap();}
\DoxyCodeLine{00181     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} \&p : plan)}
\DoxyCodeLine{00182     \{}
\DoxyCodeLine{00183         uint32\_t mx, my;}
\DoxyCodeLine{00184         costmap2d-\/>worldToMap(p.pose.position.x, p.pose.position.y, mx, my);}
\DoxyCodeLine{00185         \textcolor{keyword}{auto} cost = costmap2d-\/>getCost(mx, my);}
\DoxyCodeLine{00186 }
\DoxyCodeLine{00187         \textcolor{keywordflow}{if} (cost >= costmap\_2d::INSCRIBED\_INFLATED\_OBSTACLE)}
\DoxyCodeLine{00188         \{}
\DoxyCodeLine{00189             acceptedGlobalPlan = \textcolor{keyword}{false};}
\DoxyCodeLine{00190             \textcolor{keywordflow}{break};}
\DoxyCodeLine{00191         \}}
\DoxyCodeLine{00192     \}}
\DoxyCodeLine{00193 }
\DoxyCodeLine{00194     \mbox{\hyperlink{classcl__move__base__z_1_1backward__global__planner_1_1BackwardGlobalPlanner_a561eab039140948c52ec928c191f3f43}{planPub\_}}.publish(planMsg);}
\DoxyCodeLine{00195 }
\DoxyCodeLine{00196     \textcolor{comment}{// this was previously set to size() <= 1, but a plan with a single point is also a valid plan (the goal)}}
...
Referenced by \mbox{\hyperlink{backward__global__planner_8cpp_source_l00205}{make\+Plan()}}.
...
Definition at line \mbox{\hyperlink{backward__global__planner_8cpp_source_l00205}{205}} of file \mbox{\hyperlink{backward__global__planner_8cpp_source}{backward\+\_\+global\+\_\+planner.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00208 \{}
\DoxyCodeLine{00209     cost = 0;}
\DoxyCodeLine{00210     \mbox{\hyperlink{classcl__move__base__z_1_1backward__global__planner_1_1BackwardGlobalPlanner_a3f1f3c81e7c52c9305544fd793741a41}{makePlan}}(start, goal, plan);}
...
References \mbox{\hyperlink{backward__global__planner_8cpp_source_l00147}{make\+Plan()}}.
...
Referenced by \mbox{\hyperlink{backward__global__planner_8cpp_source_l00050}{initialize()}}, \mbox{\hyperlink{backward__global__planner_8cpp_source_l00147}{make\+Plan()}}, and \mbox{\hyperlink{backward__global__planner_8cpp_source_l00066}{publish\+Goal\+Marker()}}.
...
Referenced by \mbox{\hyperlink{backward__global__planner_8cpp_source_l00050}{initialize()}}, \mbox{\hyperlink{backward__global__planner_8cpp_source_l00147}{make\+Plan()}}, and \mbox{\hyperlink{backward__global__planner_8cpp_source_l00037}{$\sim$\+Backward\+Global\+Planner()}}.
